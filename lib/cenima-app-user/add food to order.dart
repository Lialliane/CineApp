...
import 'package:myapp/cenima-app-user/admin-food-options.dart';
...
class AddFoodToOrder extends StatefulWidget {
  ...
  AddFoodToOrder(this.bookingDetails, this.ticket, this.selectedSeatsSta,
      this.selectedSeatsPre);
  @override
  State<AddFoodToOrder> createState() => _AddFoodToOrderState(
      bookingDetails, ticket, selectedSeatsSta, selectedSeatsPre);
}
...
class _AddFoodToOrderState extends State<AddFoodToOrder> {
  ...
  _AddFoodToOrderState(this.bookingDetails, this.ticket, this.selectedSeatsSta,
      this.selectedSeatsPre);
              ...
              Navigator.pushReplacement(
                ...
                MaterialPageRoute(
                    builder: (context) => SeatSelection(
                        bookingDetails.selectedStandard,
                        bookingDetails.selectedPrime,
                        bookingDetails,
                        ticket,
                        selectedSeatsSta,
                        selectedSeatsPre)),
  ...
  modeBottomSheet(
    ...
    int? intFoodLocator = foodLocator(bookingDetails.selectedFood,
        bookingDetails.selectedFoodSize, data['name'], sizes[selectedSizeNo]);
    int notNullFoodLocator = intFoodLocator ?? 0;
    int? currentlyInOrder = (bookingDetails.selectedFood!.isNotEmpty)
        ? bookingDetails.selectedFoodNo![intFoodLocator ?? 0]
        : null;
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                          left: width * 0.05, right: width * 0.06),
                      child: Align(
                                            ...
                                            child: RadioListTile(
                                              ...
                                              onChanged: (String? value) {
                                                setState(() {
                                                  ...
                                                  intFoodLocator = foodLocator(
                                                      bookingDetails
                                                          .selectedFood,
                                                      bookingDetails
                                                          .selectedFoodSize,
                                                      data['name'],
                                                      sizes[selectedSizeNo]);
                                                  currentlyInOrder =
                                                      (bookingDetails
                                                              .selectedFoodNo!
                                                              .isNotEmpty)
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Text(
                            (double.parse(prices[selectedSizeNo]) *
                                    noOfSelectedFood)
                                .toString(),
                            textAlign: TextAlign.center,
                            style: SafeGoogleFont(
                        ...
                        Padding(
                          ...
                          child: TextButton(
                            ...
                            onPressed: () {
                              setState(() {
                                if (intFoodLocator == null) {
                                  bookingDetails.selectedFood!
                                      .add(data['name']);
                                  bookingDetails.selectedFoodSize!
                                      .add(sizes[selectedSizeNo]);
                                  bookingDetails.selectedFoodFlavor!
                                      .add([flavors[selectedFlavorNo]]);
                                  bookingDetails.selectedFoodFlavorNo!
                                      .add([noOfSelectedFood]);
                                  bookingDetails.selectedFoodNo!
                                      .add(noOfSelectedFood);
                                  bookingDetails.selectedFoodPrice!.add(
                                      double.parse(prices[selectedSizeNo]));
                                  print(
                                      "this is current selected food${bookingDetails.selectedFood.toString()}");
                                  print(
                                      " this is current selected flavor${bookingDetails.selectedFoodFlavor.toString()}");
                                } else {
                                  bookingDetails.selectedFoodNo![
                                      notNullFoodLocator] = bookingDetails
                                          .selectedFoodNo![notNullFoodLocator] +
                                      noOfSelectedFood;
                                  int count = 0;
                                  int index = 0;
                                  if (bookingDetails.selectedFoodFlavor![
                                          notNullFoodLocator] !=
                                      null) {
                                    ...
                                    for (int i = 0;
                                      ...
                                      print("insidefor");
                                      if (bookingDetails.selectedFoodFlavor![
                                              notNullFoodLocator][i] ==
                                          flavors[selectedFlavorNo]) {
                                        index = i;
                                      } else {
                                        count++;
                                      }
                                    ...
                                    if (count ==
                                      ...
                                      bookingDetails.selectedFoodFlavorNo![
                                              notNullFoodLocator]
                                          .add(noOfSelectedFood);
                                      print(bookingDetails.selectedFoodFlavor
                                          .toString());
                                    } else {
                                      print('else increase the number');
                                      bookingDetails.selectedFoodFlavorNo![
                                              notNullFoodLocator][index] +=
                                          noOfSelectedFood;
                                    }
                                  }
                                }
                              ...
                              print(
                                  " did flavors update?${bookingDetails.selectedFoodFlavor.toString()}");
                              Navigator.pop(context);
                            },
                            style: TextButton.styleFrom(
                              padding: EdgeInsets.zero,
  ...
  foodLocator(List<String>? selectedFood, List<String>? selectedFoodSize,
      String dataName, String currentSize) {
    int? doesItExist;
