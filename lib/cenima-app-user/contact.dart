        ...
        child: Stack(
          children: [
            Positioned(
              ...
              child: Container(
                padding:
                    EdgeInsets.fromLTRB(30 * fem, 8 * fem, 30 * fem, 31 * fem),
                width: 391 * fem,
                height: 742 * fem,
                decoration: const BoxDecoration(
                  color: Color(0xfff1f1f1),
