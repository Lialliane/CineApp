...
List<String> paragraphs = [
  ...
  'Makes the booking process easier, giving you all the details you need.',

  'Own a movie for a short time without having to pay an expensive fee.',

  "We make it easy to see what food is available so you can enjoy your experience without delays.",
